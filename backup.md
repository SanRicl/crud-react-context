...
function App() {
  ...
  const handleDelete = (e, index) => {
    ...
    //removedProducts vai retornar o  ID que foi removido // Eu posso remover essa variavel removedProducts.
    const removedProducts = newProducts.splice(findIndex(index), 1);
